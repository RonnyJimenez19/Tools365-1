    ...
    <div class="col-12 col-xl-7">
        <div class="dash-card">
            <div class="card-header-row">
                <h3><i class="bi bi-box-seam me-2" style="color:#534AB7;"></i>Mis publicaciones</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="pub-actions">
                                    <a href="#" class="btn-tbl-edit"><i class="bi bi-pencil-fill"></i></a>
    ...
    <div class="col-12 col-xl-5">
        <div class="dash-card">
            ...
            <div class="auction-item">
                ...
                <div class="auction-info flex-grow-1">
        ...
        <div class="review-item">
            ...
            <div class="review-body">
                ...
                <div class="review-reply">
                    <i class="bi bi-reply-fill mt-1"></i>
